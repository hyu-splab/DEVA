...
public class StatusLogger {
    ...
    public static void log(EDACam innerCam, EDACam outerCam, List<EDAWorker> workers, long sizeDelta, int networkLevel) {
    ...
    public static String writeLogsV2(Context context, File file) {
        ...
        sb.append("Index,Time,innerF,outerF,innerWaiting,outerWaiting,pendingSize,sizeDelta,networkLevel,W0.con,W0.t,W0.iw,W0.ip,W0.ow,W0.op,W1.con,W1.t,W1.iw,W1.ip,W1.ow,W1.op,W2.con,W2.t,W2.iw,W2.ip,W2.ow,W2.op\n");
        ...
        for (StatusLog log : statusLogs) {
            ...
            for (WorkerStatusLog status : log.workerStatuses) {
                sb.append(status.isConnected ? 1 : 0).append(",").append(status.temperature).append(",");
